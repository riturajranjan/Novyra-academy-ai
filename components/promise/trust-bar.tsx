        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-body-sm text-foreground leading-tight font-semibold">{item.label}</span>
              <span className="text-caption text-foreground-secondary leading-tight">{item.detail}</span>
            </div>
          </motion.div>
        );
      })}
