...
import { conceptBuilds, processSteps, techStackBadges, type CaseStudyFilter } from "@/content/case-studies";
    ...
    <section id="case-studies" className="relative isolate overflow-hidden py-14 md:py-32">
      ...
      <Container className="flex flex-col gap-10 md:gap-14">
        <SectionHeading
          ...
          description="Explore concept builds across healthcare, education, retail, and SaaS — each one showing how we'd approach a real-world product challenge, from architecture to launch."
        />
        ...
        <div className="flex flex-col items-center gap-6">
          <p className="text-caption text-foreground-secondary text-center font-semibold tracking-wide uppercase">
            How a concept like this comes together
          </p>
          <ol className="flex w-full max-w-3xl items-start justify-between">
            {processSteps.map((step, i) => (
              <li key={step} className={cn("flex items-center", i < processSteps.length - 1 && "flex-1")}>
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-caption text-foreground-secondary hidden font-medium sm:block">{step}</span>
                </div>
        ...
        <div className="glass-strong shadow-card relative flex flex-col items-center gap-6 overflow-hidden rounded-[28px] p-8 text-center sm:flex-row sm:justify-between sm:p-10 sm:text-left">
          ...
          <div className="flex flex-col gap-2">
            <h3 className="text-title-lg text-foreground font-semibold">Ready to Bring Your Idea to Life?</h3>
            <p className="text-body-sm text-foreground-secondary max-w-md">
              Let&apos;s create a digital product that delivers measurable business results.
            </p>
          </div>
